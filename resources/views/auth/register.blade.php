                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="{{ __('Name') }}" value="{{ old('name') }}" required autofocus autocomplete="name">
                                    <x-generic.input-error :messages="$errors->get('name')" class="invalid-feedback mt-2" />
                                </div>
                            </div>

                            <div class="form-group mb-4">
                                <div class="input-group input-group-lg">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="{{ __('Email') }}" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="form-control mb-4 d-flex justify-content-between bg-gray-light p-2">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="signup-terms" name="signup-terms" />
                                    <label class="form-check-label" for="signup-terms">{{ __('I agree to the') }} <a href="#" data-bs-toggle="modal" data-bs-target="#modal-terms">{{ __('Terms & Conditions') }}</a></label>
                                </div>
                            </div>

                            @if ($errors->get('signup-terms'))
                                <div class="form-group mb-4">
                                    <x-generic.input-error :messages="$errors->get('signup-terms')[0]" class="text-danger mt-2" />
                                </div>
                            @endif
