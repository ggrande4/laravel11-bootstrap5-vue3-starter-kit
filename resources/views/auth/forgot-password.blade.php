                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-2 text-center">
                            <p class="fw-bold fs-sm text-muted">{{ __('Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.') }}</p>
                        </div>

                        @if(session('status'))
                            <div class="d-inline-block px-3 py-1 mb-4 fs-sm fw-semibold w-100 text-success bg-success-light">
                                <p class="fw-bold fs-sm text-muted">{{ session('status') }}</p>
                            </div>
                        @endif
                    ...
                    <div class="card-footer text-end">
                        <a class="fw-medium" href="{{ route('login') }}">{{ __('Signin') }}</a>
                    </div>
                </div>
            </div>
        </div>
