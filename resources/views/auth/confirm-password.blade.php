<x-auth-layout>
    <div class="bg-image" style="background-image: url({{ asset('assets/media/images/image1.webp') }})">
        <div class="row g-0 justify-content-center bg-primary-dark-op vh-100">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-2 text-center">
                            <p class="fw-bold fs-sm text-muted">{{ __('This is a secure area of the application. Please confirm your password before continuing.') }}</p>
                        </div>
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ route('logout') }}" class="fw-medium">{{ __('Log Out') }}</a>
                    </div>
                </div>
            </div>
        </div>
